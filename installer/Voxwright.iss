#define MyAppName "Voxwright"
#define MyAppVersion GetEnv('APP_VERSION')
#if MyAppVersion == ""
  #define MyAppVersion "0.0.0"
#endif
#define MyAppPublisher "Sev7eNup"
#define MyAppURL "https://github.com/Sev7eNup/Voxwright"
#define MyAppExeName "Voxwright.App.exe"
...
OutputDir=..\output
OutputBaseFilename=Voxwright-Setup-{#MyAppVersion}
SetupIconFile=..\src\Voxwright.App\Resources\Icons\app.ico
...
Name: "launchstartup"; Description: "Start Voxwright with Windows"; GroupDescription: "Startup:"; Flags: unchecked
...
[Run]
Filename: "{app}\{#MyAppExeName}"; Description: "Launch Voxwright"; Flags: nowait postinstall skipifsilent
