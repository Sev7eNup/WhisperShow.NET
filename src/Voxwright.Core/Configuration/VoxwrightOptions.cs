...
/// <summary>
/// Root configuration class for Voxwright, bound to the "Voxwright" section in appsettings.json.
...
public class VoxwrightOptions
{
    ...
    /// otherwise falls back to %APPDATA%/Voxwright/{subfolder}.
    /// </summary>
...
public class LocalWhisperOptions
{
    ...
    /// <summary>Custom directory for GGML model files. Null uses %APPDATA%/Voxwright/models.</summary>
    ...
    public string GetModelDirectory() =>
        VoxwrightOptions.ResolveModelDirectory(ModelDirectory, "models");
}
...
public class ParakeetOptions
{
    ...
    /// <summary>Custom directory for Parakeet model files. Null uses %APPDATA%/Voxwright/parakeet-models.</summary>
    public string? ModelDirectory { get; set; }
    ...
    /// <summary>Returns the resolved model directory, falling back to the default AppData location.</summary>
    public string GetModelDirectory() =>
        VoxwrightOptions.ResolveModelDirectory(ModelDirectory, "parakeet-models");
}
...
public class VoiceActivityOptions
{
    ...
    /// <summary>Custom directory for the Silero VAD model file. Null uses %APPDATA%/Voxwright/vad-models.</summary>
    public string? ModelDirectory { get; set; }

    /// <summary>Returns the resolved model directory, falling back to the default AppData location.</summary>
    public string GetModelDirectory() =>
        VoxwrightOptions.ResolveModelDirectory(ModelDirectory, "vad-models");
}
...
public class TextCorrectionOptions
{
    ...
    /// <summary>Custom directory for local correction GGUF models. Null uses %APPDATA%/Voxwright/correction-models.</summary>
    ...
    public string GetLocalModelDirectory() =>
        VoxwrightOptions.ResolveModelDirectory(LocalModelDirectory, "correction-models");
...
/// <summary>
/// Validates <see cref="VoxwrightOptions"/> constraints at startup and on configuration reload.
...
/// </summary>
public class VoxwrightOptionsValidator : IValidateOptions<VoxwrightOptions>
{
    public ValidateOptionsResult Validate(string? name, VoxwrightOptions options)
    {
