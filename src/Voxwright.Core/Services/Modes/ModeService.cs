...
namespace Voxwright.Core.Services.Modes;
...
public class ModeService : IModeService
{
    ...
    public ModeService(ILogger<ModeService> logger, IOptionsMonitor<VoxwrightOptions> optionsMonitor)
    {
        _logger = logger;
        _optionsMonitor = optionsMonitor;
        _filePath = Path.Combine(
            Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData),
            "Voxwright", "modes.json");
