...
public class SettingsViewModelTests
{
    ...
    private SettingsViewModel CreateViewModel(Action<VoxwrightOptions>? configure = null)
    {
    ...
    [Fact]
    public void VersionText_ContainsVoxwright()
    {
        var vm = CreateViewModel();
        vm.VersionText.Should().StartWith("Voxwright v");
    }
