...
public class VoxwrightOptionsTests
{
    /// <summary>
    ...
    /// </summary>
    private static VoxwrightOptions CreateValidOptions() => new()
    {
    ...
    public void GetModelDirectory_WithEmpty_ReturnsFallback()
    {
        ...
        options.GetModelDirectory().Should().Contain("Voxwright");
    }

    // --- VoxwrightOptionsValidator ---
    ...
    public void Validator_DefaultOptions_BeforeSetup_Succeeds()
    {
        ...
        var result = validator.Validate(null, new VoxwrightOptions());
    ...
    public void Validator_DefaultOptions_AfterSetup_RequiresApiKey()
    {
        ...
        var validator = new VoxwrightOptionsValidator();
        var options = new VoxwrightOptions { App = new AppOptions { SetupCompleted = true } };
    ...
    {
        var validator = new VoxwrightOptionsValidator();
        var options = new VoxwrightOptions { Audio = new AudioOptions { MaxRecordingSeconds = seconds } };
    ...
    {
        var validator = new VoxwrightOptionsValidator();
        var options = new VoxwrightOptions { Overlay = new OverlayOptions { AutoDismissSeconds = 0 } };
    ...
    {
        var validator = new VoxwrightOptionsValidator();
        var options = new VoxwrightOptions { Overlay = new OverlayOptions { Scale = scale } };
    ...
    {
        var validator = new VoxwrightOptionsValidator();
        var options = new VoxwrightOptions { OpenAI = new OpenAiOptions { Endpoint = "not-a-url" } };
    ...
    public void ParakeetOptions_GetModelDirectory_WithNull_ReturnsAppDataPath()
    {
        ...
        result.Should().Contain("Voxwright");
