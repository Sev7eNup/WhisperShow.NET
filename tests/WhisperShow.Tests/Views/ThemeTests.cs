...
public class ThemeTests
{
    ...
    public void DarkTheme_LoadsSuccessfully()
    {
        ...
        {
            Source = new Uri("/WhisperShow.App;component/Themes/SettingsDarkTheme.xaml", UriKind.Relative)
        };
    ...
    public void LightTheme_LoadsSuccessfully()
    {
        var dict = new ResourceDictionary
        {
            Source = new Uri("/WhisperShow.App;component/Themes/SettingsLightTheme.xaml", UriKind.Relative)
        };
